...
<body>
    <div class="div_main">
        ...
        <div class="cycle-slideshow">
            <img src="../imgs/IMG_3037.jpg">
                <img src="../imgs/IMG_3030.jpg">
                <img src="../imgs/IMG_2980.jpg">
        </div>
        <div class="section">
            <nav class="main1">
                <img src="../imgs/IMG_2969.jpg">
                <img src="../imgs/IMG_3248.jpg">
                <img src="../imgs/IMG_3041.jpg">
                <img src="../imgs/IMG_3982.jpg">
                <img src="../imgs/IMG_4121.jpg">
            </nav>
            <nav class="main1">
                <img src="../imgs/IMG_2793.jpg">
                <img src="../imgs/IMG_3760.jpg">
                <img src="../imgs/IMG_3944.jpg">
                <img src="../imgs/IMG_4094.jpg">
                <img src="../imgs/IMG_4150.jpg">
            </nav>
        </div>
        <footer class="ft1">
            <nav class="nv3">
