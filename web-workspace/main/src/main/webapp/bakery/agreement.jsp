...
<head>
    ...
    <title>회원약관페이지(agreement.html)</title>
...
<div class="div_main">
    ...
    <h2>회원 동의 약관</h2>
    <textarea name="agreement" cols="80" rows="20"><!--행이 20줄 폭 80-->
        제 1 조 (약관의 적용)
    ...
    <input type="button" value="동의함" onclick="document.location='Register.html'">
    <input type="button" value="동의안함" onclick="history.back()"><!--뒤로 이동-->
              <footer class="ft1">
            <nav class="nv3">
                <ul>
                    <li><a href="#">HOME</a></li>
